...
try {
    ...
    $transactionReport = $conn->prepare("SELECT transactions.*, accounts.name as account, departments.name as department, treasures.name as treasure FROM transactions INNER JOIN accounts ON transactions.account_id = accounts.id INNER JOIN treasures ON transactions.treasure_id = treasures.id INNER JOIN departments ON  transactions.department_id = departments.id WHERE treasure_id = :id");
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title" style="display:flex">
                                <div class="ml-4"><b>خزانه / بودجه : </b> <span><?php echo $_GET['name']; ?></span></div>
                                <div class="ml-5 mr-5"><b>موجودي :</b> <span><?php echo $_GET['balance']; ?></span></div>
